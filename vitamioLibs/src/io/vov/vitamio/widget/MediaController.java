...
public class MediaController extends FrameLayout {
  ...
  private ImageView mBackBtn, mScreenBtn;
  ...
  public MediaController(Activity activity, View container) {
    super(activity);
    //初始化AudioManager
    ...
    LayoutParams p = new LayoutParams(LayoutParams.MATCH_PARENT, container.getHeight());
  ...
  private void initControllerView(View v) {
    ...
    //此处修改，增加全屏按钮及响应点击事件
    mScreenBtn = (ImageView) v.findViewById(R.id.full_btn);
    mScreenBtn.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        if(mActivity.getRequestedOrientation()== ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
          //改变图片资源
          mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
          mScreenBtn.setImageResource(R.drawable.small_screen);
        }else{
          //改变图片资源
          mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
          mScreenBtn.setImageResource(R.drawable.full_screen);
        }
      }
    });

    //返回键盘
    mBackBtn = (ImageView) v.findViewById(R.id.back_btn);
...
//    mScreenBtn.setSelected(isSelected);
//  }
